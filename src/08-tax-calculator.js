...
export function calculateTax(income) {
  ...
  else if (income > 10000 && income <= 30000) return (income-10000) * (10/100);
  else if (income > 30000 && income <= 70000) return (income-30000) * (20/100) + 2000;
  else if (income > 70000) return (income - 70000) * (30/100) + 2000 + 8000;
  else return 0
}
